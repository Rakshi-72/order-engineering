 ...
 *
 * <p>Legacy EMDs are gone.  Bags, meals, Wi-Fi — they are just another item
 * in the same cart, same payment, same lifecycle.</p>
 *
 * <p>{@link #linkedFlightItemId} is nullable by design: a meal is per-segment
 * (linked), but travel insurance is order-wide (not linked).</p>
 */
public class AncillaryItem extends OrderItem {
    ...
    public UUID          getLinkedFlightItemId() { return linkedFlightItemId; }

    /** true when this ancillary is tied to a specific flight segment. */
    public boolean isLinkedToFlight() { return linkedFlightItemId != null; }
    ...
    public static class Builder {
        ...
        public Builder type(AncillaryType type)                  { this.type               = type;               return this; }
        public Builder linkedFlightItemId(UUID linkedFlightItemId) { this.linkedFlightItemId = linkedFlightItemId; return this; }
